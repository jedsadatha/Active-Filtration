...
**Project Overview**: _"How can pollen affect your life?"_ Active Filtration is an experiential data visualization that reacts dynamically to real-time environment data and user presence. 

The display is divided into three vertical panels representing the core allergy seasons: _Spring (left)_, _Summer (center)_, and _Fall (right)_. As users approach the installation, face-tracking technology attaches season-specific pollen particles to their faces. The density of these particles isn't arbitrary—it is driven by live, daily pollen count data for Atlanta, GA.
...
<p align="center">
  <img width="620" height="437" alt="Screenshot 2026-05-25 204156" src="https://github.com/user-attachments/assets/a5a9b96e-cc9d-4818-b8fb-cf1b8cf20b51" />
</p>
